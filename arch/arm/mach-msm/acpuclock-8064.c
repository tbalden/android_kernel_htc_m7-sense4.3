...
static struct acpu_level tbl_PVS1_1700MHz[] __initdata = {
	...
	{ 1, {   384000, PLL_8, 0, 0x00 }, L2(0),   912500 },
	{ 1, {   486000, HFPLL, 2, 0x24 }, L2(5),   925000 },
	{ 1, {   594000, HFPLL, 1, 0x16 }, L2(5),   937500 },
	...
	{ 1, {  1242000, HFPLL, 1, 0x2E }, L2(14), 1075000 },
	{ 1, {  1350000, HFPLL, 1, 0x32 }, L2(14), 1100000 },
	{ 1, {  1458000, HFPLL, 1, 0x36 }, L2(14), 1125000 },
...
static struct acpu_level tbl_PVS2_1700MHz[] __initdata = {
	...
	{ 1, {   162000, HFPLL, 2, 0x0C }, L2(0),   862500 },
	{ 1, {   270000, HFPLL, 2, 0x14 }, L2(0),   875000 },
	{ 1, {   384000, PLL_8, 0, 0x00 }, L2(0),   887500 },
...
static struct acpu_level tbl_PVS3_1700MHz[] __initdata = {
	...
	{ 1, {  1674000, HFPLL, 1, 0x3E }, L2(14), 1125000 },
	{ 1, {  1728000, HFPLL, 1, 0x40 }, L2(14), 1150000 },
	{ 1, {  1836000, HFPLL, 1, 0x44 }, L2(14), 1200000 },
	{ 1, {  1890000, HFPLL, 1, 0x46 }, L2(14), 1225000 },
	{ 1, {  1944000, HFPLL, 1, 0x48 }, L2(14), 1250000 },
        { 1, {  1998000, HFPLL, 1, 0x4A }, L2(14), 1275000 },
	{ 0, { 0 } }
};
...
static struct acpu_level tbl_PVS4_1700MHz[] __initdata = {
	...
	{ 1, {   918000, HFPLL, 1, 0x22 }, L2(5),   950000 },
	{ 1, {  1026000, HFPLL, 1, 0x26 }, L2(5),   975000 },
	{ 1, {  1134000, HFPLL, 1, 0x2A }, L2(14),  987500 },
	...
	{ 1, {  1890000, HFPLL, 1, 0x46 }, L2(14), 1200000 },
...
static struct acpu_level tbl_PVS5_1700MHz[] __initdata = {
	...
	{ 1, {   162000, HFPLL, 2, 0x0C }, L2(0),   837500 },
	{ 1, {   270000, HFPLL, 2, 0x14 }, L2(0),   850000 },
	{ 1, {   384000, PLL_8, 0, 0x00 }, L2(0),   862500 },
	{ 1, {   486000, HFPLL, 2, 0x24 }, L2(5),   875000 },
